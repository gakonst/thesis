...
\subsubsection{Method 1: Packing of traits by utilizing Solidity's optimizer and \texttt{struct} variables} \label{method1}
...
\begin{figure}[ht!]
    ...
    \caption{Although Method 2 is the least readable, it is the most efficient in terms of gas.}
    \label{fig:method2}
