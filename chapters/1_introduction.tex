...
\begin{enumerate}\label{statement}
    ...
    \item How can a system that is able to measure and bill the energy consumed by a set of energy meters be modeled through the use of the Ethereum blockchain? 
